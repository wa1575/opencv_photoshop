...
{
    #LIBS += -LC:\opencv\build\x64\vc15\bin\opencv_world451d.dll
    LIBS += -LC:\opencv\build\x64\vc15\lib -lopencv_world451d
    #LIBS += -LC:\opencv\build\x64\vc15\lib\opencv_world451d.lib


}
CONFIG(release,debug|release)
{
    #LIBS += C:\opencv\build\x64\vc15\bin\opencv_world451.dll
